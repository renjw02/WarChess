...
QT_MOC_LITERAL(1, 6, 10), // "changeTerm"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 7), // "asignal"
QT_MOC_LITERAL(4, 26, 9), // "anyoneDie"
QT_MOC_LITERAL(5, 36, 8) // "gameOver"

    },
    "MyMap\0changeTerm\0\0asignal\0anyoneDie\0"
    "gameOver"
};
...
void MyMap::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->changeTerm(); break;
        case 1: _t->asignal(); break;
        case 2: _t->anyoneDie(); break;
        ...
        {
            using _t = void (MyMap::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyMap::changeTerm)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MyMap::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyMap::asignal)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (MyMap::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyMap::anyoneDie)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (MyMap::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyMap::gameOver)) {
                *result = 3;
                return;
            }
        }
